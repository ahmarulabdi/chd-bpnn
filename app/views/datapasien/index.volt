    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
          <div class="form-group">
              <a class="btn btn-success" href="{{url('dataasien/tambahdatapasien')}}">
                  <i class="glyphicon glyphicon-plus"></i>Tambah Data
              </a>
              {% set validasi = 'check' %}
              <a class="btn btn-primary pull-right" href="{{url('datapasien/normalisasivalidasi/'~validasi)}}">
          ...
          <table class="table table-striped table-bordered table-hover">
              ...
              {% for  datapasien in datapasiens %}
                  <tr>
                      ...
                      <td>
                          <a href="{{ url('datapasien/datapasiendetail/'~datapasien.no) }}" class="btn btn-info">
                              Detail
                          </a>
                      </td>
                  </tr>
